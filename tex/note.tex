...
\begin{abstract}
  ...
  The Census Bureau is required by law to protect this data from disclosure where data provided by any individual can be identified, and, for the first two major releases from the 2020 Decennial Census, it used a novel approach to meet this requirement, the TopDown Algorithm.
